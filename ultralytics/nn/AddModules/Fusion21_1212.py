...
class ECAAttention1(nn.Module):
    def __init__(self, ch_in, weight1, weight2, kernel_size = 3, kernel_size1 = 1):
        super().__init__()
        self.gap = nn.AdaptiveAvgPool2d(1)
...
class MF_21(nn.Module):  # stereo attention block
    def __init__(self, channels):
        super(MF_21, self).__init__()
        ...
        self.se_r = ECAAttention1(3, 0.342041015625, 0.91943359375)
        self.se_i = ECAAttention1(3, 0.68603515625, 0.52001953125)
